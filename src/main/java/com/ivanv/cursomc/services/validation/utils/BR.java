package com.ivanv.cursomc.services.validation.utils;

//Font: https://github.com/adrianoluis/misc-tools/blob/master/src/main/java/net/adrianoluis/tools/util/DocumentUtil.java
public class BR {
